  ...
  return (
    <div className="App">
      ...
      <div className="control is-expanded section">
        <input
        placeholder="words will disappear when you press spacebar dont panic and press it after completing your word only"
          ref={textInput}
      ...
      <div className="section">
        <button
          className="button is-black is-fullwidth is-rounded"
          onClick={start}
        >
          Start
        </button>
          ...
          <div className="columns">
            ...
            <div className="column has-text-centered">
              ...
              {correct !== 0 ? (
                ...
                <p className="has-text-black is-size-1">0%</p>
              )}
            </div>
          </div>
        </div>
